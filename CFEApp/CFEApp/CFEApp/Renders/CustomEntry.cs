...
namespace CFEApp
{
    public class CustomEntry : Entry
    {
        public static readonly BindableProperty IconLeftProperty = 
            BindableProperty.Create(nameof(IconLeft), typeof(string), typeof(CustomEntry), string.Empty);
        ...
        public static readonly BindableProperty IconRightProperty =
            BindableProperty.Create(nameof(IconRight), typeof(string), typeof(CustomEntry), string.Empty);
